...
const About = (isDarkMode) => {
  return (
    ...
    transition={{ duration: 0.6, delay: 0.8 }}
        ...
        initial={{opacity: 0, y: -20}}
        whileInView={{opacity: 1, y: 0}}
        transition={{duration: 0.8, delay: 0.3}} className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
        ...
        transition={{ delay: 1.3, duration: 0.5 }}         
         className='my-6 text-gray-700 font-Ovo dark:text-white/80'>Design Tools I use</motion.h4>
         <motion.ul 
         initial={{ opacity: 0}}
        whileInView={{ opacity: 1}}
        ...
        whileHover={{ scale: 1.1 }} className='flex items-center justify-center w-12 sm:w-14 aspect-square border
